...
data2 <- read.table(file.path(current_dir, "TeTranscript/10month/FM_JLR_Long10MonthYoungvsOldTreated.cntTable"), header=T, row.names=1)
...
pheatmap(cor_matrix,
         cluster_rows = TRUE,
         cluster_cols = TRUE,
         main = "Fig 9b:Sample-to-Sample Correlations TE (10month treatment)",
...
png(file.path(current_dir,"Figuras/Fig 9b: Heatmap Sample-to-Sample Correlations TE.jpg"), width = 800, height = 600)
