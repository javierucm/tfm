...
png(file.path(current_dir,"Figuras/Fig 8b: Volcanoplot_All_TE_Paper_YoungVsOldTreated_10month.png"), width = 800, height = 600)
ggplot(data, aes(x = log2FoldChange, y = -log10(padj), color = category)) +
  ...
  labs(title = "Fig 8b: TE: 22 months +doxycycline(10month) / 3 months -doxycycline",
       x = "Log2 Fold Change",
