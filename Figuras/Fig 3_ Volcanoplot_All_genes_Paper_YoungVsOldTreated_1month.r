...
png(file.path(current_dir,"Figuras/Fig 3: Volcanoplot_All_genes_Paper_YoungVsOldTreated_1month.png"), width = 800, height = 600)
ggplot(data, aes(x = log2FoldChange, y = -log10(padj), color = category)) +
  ...
  labs(title = "Fig 3 - Genes: 26 months +doxycycline (1month) / 3 months -doxycycline",
       x = "Log2 Fold Change",
